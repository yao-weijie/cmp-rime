...
void RimeCleanupStaleSessions(void);
void RimeCleanupAllSessions(void);
...
Bool RimeCandidateListBegin(RimeSessionId session_id,
...
Bool RimeCandidateListFromIndex(RimeSessionId session_id,
                                RimeCandidateListIterator *iterator, int index);
...
void RimeSetProperty(RimeSessionId session_id, const char *prop,
                     const char *value);
Bool RimeGetProperty(RimeSessionId session_id, const char *prop, char *value,
                     size_t buffer_size);

Bool RimeGetSchemaList(RimeSchemaList *schema_list);
void RimeFreeSchemaList(RimeSchemaList *schema_list);
Bool RimeGetCurrentSchema(RimeSessionId session_id, char *schema_id,
                          size_t buffer_size);
...
// installation.yaml
Bool RimeUserConfigOpen(const char *config_id, RimeConfig *config);
...
Bool RimeConfigGetString(RimeConfig *config, const char *key, char *value,
                         size_t buffer_size);
...
Bool RimeConfigSetString(RimeConfig *config, const char *key,
                         const char *value);
...
Bool RimeConfigBeginList(RimeConfigIterator *iterator, RimeConfig *config,
                         const char *key);
Bool RimeConfigBeginMap(RimeConfigIterator *iterator, RimeConfig *config,
                        const char *key);
...
Bool RimeSimulateKeySequence(RimeSessionId session_id,
...
const char *RimeGetSyncDir(void);
const char *RimeGetUserId(void);
...
typedef struct rime_api_t {
    ...
    void (*set_option)(RimeSessionId session_id, const char *option,
                       Bool value);
    Bool (*get_option)(RimeSessionId session_id, const char *option);

    void (*set_property)(RimeSessionId session_id, const char *prop,
                         const char *value);
    Bool (*get_property)(RimeSessionId session_id, const char *prop,
    ...
    Bool (*get_current_schema)(RimeSessionId session_id, char *schema_id,
                               size_t buffer_size);
    ...
    Bool (*config_get_double)(RimeConfig *config, const char *key,
                              double *value);
    Bool (*config_get_string)(RimeConfig *config, const char *key, char *value,
                              size_t buffer_size);
    ...
    Bool (*config_begin_map)(RimeConfigIterator *iterator, RimeConfig *config,
                             const char *key);
    ...
    Bool (*config_set_double)(RimeConfig *config, const char *key,
                              double value);
    Bool (*config_set_string)(RimeConfig *config, const char *key,
                              const char *value);

    // configuration: manipulating complex structures
    Bool (*config_get_item)(RimeConfig *config, const char *key,
                            RimeConfig *value);
    Bool (*config_set_item)(RimeConfig *config, const char *key,
                            RimeConfig *value);
    ...
    Bool (*config_begin_list)(RimeConfigIterator *iterator, RimeConfig *config,
                              const char *key);
    ...
    const char *(*get_state_label)(RimeSessionId session_id,
                                   const char *option_name, Bool state);
